...
import { getClearanceProposalList } from "../../../services/dashboard/userInfoServices";
import { dateToPersian } from "../../../helper/general";
import { useHistory, useParams } from "react-router";
import BackDrop from "../../../common/backDrop/BackDrop";

const ClearanceProposalListRegistered = ({ backToTab }) => {
  ...
  const showDetailHandler = (proposalId) => {
    history.push(
      `/Dashboard/suggestionsList/SingleClearanceProposal/${proposalId}`
    );
  };
