      ...
      <div className={classes.main}>
        <div className={classes.newsField}>
          ...
          <Typography className={classes.newsText} align="left" variant="body1">
            ...
            که از نظر من به عنوان یک کارشناس اقتصادی، اصلا به نفع شان نیست وی
            تصریح کرد: همان گونه که شما هنگام فروش یک قطعه طلا، تمام ملاحظات را
            در نظر می گیرید، در مورد فروش سهام نیز باید دقت لازم را بکار ببندید،
            به ویژه با توجه به اینکه، سهام از ویژگی سود آوری نیز برخوردار است
            وزیر اقتصاد ابراز امیدواری کرد، با فراهم شدن زمینه اجرای برنامه های
            اعلامی ریاست جدید سازمان بورس و اوراق بهادار در سال جدید، بازار به
            شرایط پایدار خود برسد بنا بر این گزارش، وزیر اقتصاد در پاسخ به سؤالی
            در خصوص شرایط گمرکات کشور از نظر ترخیص کالا نیز با بیان اینکه زمان
            ترخیص کالا به شدت کاهش یافته است، گفت: با تجهیز گمرک جمهوری اسلامی
            به ابزار های مدرن و الکترونیکی شدن ارزیابی ها، نیاز به نیروی انسانی
            برای انجام عملیات به حداقل ممکن رسیده است دژپسند با اشاره به اینکه
            نظارت پیشینی در گمرکات کشور به نظارت پسینی بدل شده است، گفت: در حال
            حاضر تمام شرایط به نحوی فراهم شده که در صورت انجام "ثبت سفارش" و
            "تأمین ارز" وارد کنندگان، (و در صورت لزوم و برای کالای اساسی و مواد
            غذایی، تأیید استاندارد و وزارت بهداشت) در کوتاه ترین زمان ممکن،
            امکان ترخیص کالا فراهم شده است که در این خصوص رکورد ۲۴ ساعت را هم به
            ثبت رسانده ایم وزیر اقتصاد با اشاره به تعیین شعار "تولید،
            پشتیبانی‌ها، مانع‌زدایی" برای امسال از سوی مقام معظم رهبری، گفت:
            گمرک جمهوری اسلامی با لحاظ سه مؤلفه "تسهیل واردات مواد اولیه و
